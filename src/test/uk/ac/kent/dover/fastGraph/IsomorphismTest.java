...
import uk.ac.kent.dover.fastGraph.Isomorphism;
...
public class IsomorphismTest {
	...
	public void test001() throws Exception {
		...
		i = new Isomorphism(g1);
		assertTrue(i.isomorphic(g2));
	...
	public void test015() throws FastGraphException {
		FastGraph g1 = null;
		try {
			g1 = FastGraph.randomGraphFactory(10,30,2,true,false);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	...
	public void test016() throws FastGraphException {
		FastGraph g1 = null;
		try {
			g1 = FastGraph.randomGraphFactory(20,60,3,true,false);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		FastGraph g2 = ExactIsomorphism.generateRandomIsomorphicGraph(g1,3,false);
		Isomorphism i = new Isomorphism(g1);
		assertTrue(i.isomorphic(g2));
	}
	...
	public void test017() throws FastGraphException {
		FastGraph g1 = null;
		try {
			g1 = FastGraph.randomGraphFactory(30,90,4,true,false);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		FastGraph g2 = ExactIsomorphism.generateRandomIsomorphicGraph(g1,4,false);
		Isomorphism i = new Isomorphism(g1);
		assertTrue(i.isomorphic(g2));
	}
}
