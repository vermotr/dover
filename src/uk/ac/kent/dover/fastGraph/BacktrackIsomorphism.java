 ...
 */
public class BacktrackIsomorphism {
	 ...
	 */
	public BacktrackIsomorphism(FastGraph graph) throws FastGraphException {
	...
	public static boolean isomorphic(FastGraph g1, FastGraph g2) throws FastGraphException {
		BacktrackIsomorphism i = new BacktrackIsomorphism(g1);
